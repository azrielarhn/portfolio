  ...
  return (
    <section id="projects" ref={ref} className="scroll-mt-28 mb-28">
      <div className="flex justify-center">
        ...
        <BurstBload2 />
        <p>
          "I have worked on various projects, from small-scale ones to full-scale applications, successfully developing a wide range of features and functions that enhance the performance and value of each project."
        </p>
      </div>
      {/* <div>
