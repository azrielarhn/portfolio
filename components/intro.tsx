...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Azriel Akbar Herdiansyah</span>
      </motion.h1>
      <motion.h4
      ...
      >
        ...
        <span className="font-bold"></span> Web Developer
      ...
      >
        <a
          ...
          href="https://www.linkedin.com/in/azrielarhn/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="mailto:azrielakbarhh@gmail.com"
          target="_blank"
        >
          <RiMailSendLine />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://github.com/azrielarhn"
          target="_blank"
        >
          <FaGithubSquare />
        </a>
        <a
          className="bg-white p-4 text-gray-700 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] hover:text-gray-950 active:scale-105 transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60"
          href="https://www.instagram.com/azrielarhn/"
          target="_blank"
        >
          <BsInstagram />
        </a>
