  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 -mt-6 dark:text-white/80">
        I am currently open to job opportunities. If you have an interesting project or need extra hands, feel free to reach out!
        <br />
        <br />
        Contact me anytime if you need assistance or would like to discuss anything. I am more than happy to help!
      </p>
